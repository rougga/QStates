$(document).ready(function () {
    //table show/hide
    $("#userTbl,#extraTbl,#goalTbl").hide();
    $("#cibleBtn").on('click', function () {
        $("#cibleTbl").slideDown("slow");
        $("#userTbl,#extraTbl,#goalTbl").slideUp("slow");
        //color
        $("#userBtn,#extraBtn,#goalBtn").removeClass("btn-primary").addClass("btn-secondary");
        $("#cibleBtn").addClass("btn-primary").removeClass("btn-secondary");
    });
    $("#userBtn").on('click', function () {
        $("#userTbl").slideDown("slow");
        $("#cibleTbl,#extraTbl,#goalTbl").slideUp("slow");
        //color
        $("#cibleBtn,#extraBtn,#goalBtn").removeClass("btn-primary").addClass("btn-secondary");
        $("#userBtn").addClass("btn-primary").removeClass("btn-secondary");
    });
    $("#extraBtn").on('click', function () {
        $("#extraTbl").slideDown("slow");
        $("#cibleTbl,#userTbl,#goalTbl").slideUp("slow");
        //color
        $("#userBtn,#cibleBtn,#goalBtn").removeClass("btn-primary").addClass("btn-secondary");
        $("#extraBtn").addClass("btn-primary").removeClass("btn-secondary");
    });
    $("#goalBtn").on('click', function () {
        $("#goalTbl").slideDown("slow");
        $("#cibleTbl,#userTbl,#extraTbl").slideUp("slow");
        //color
        $("#userBtn,#cibleBtn,#extraBtn").removeClass("btn-primary").addClass("btn-secondary");
