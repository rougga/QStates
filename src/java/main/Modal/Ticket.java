...
public class Ticket {
    ...
    public Ticket(String id, String biz_type_id, String ticket_id, String evaluation_id, String ticket_type, int status, String deal_win, String transfer_win, String deal_user, String id_card_info_id, Date ticket_time, Date call_time, Date start_time, Date finish_time, String call_type, String branch_id, String id_card_name) {
        this.id = id;
