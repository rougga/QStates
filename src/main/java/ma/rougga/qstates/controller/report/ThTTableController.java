...
public class ThTTableController {

    public ThTTableController() {
    }

    public JSONObject generateNdtTable(String d1, String d2) throws SQLException {
        ...
        String SQL = "Select "
                + "b.name as service_name, b.id as service_id,"
